...
#if !defined( _FSCLFSTOOLS_GETOPT_H )
#define _FSCLFSTOOLS_GETOPT_H
...
typedef struct fsclfstools_option fsclfstools_option_t;

struct fsclfstools_option
{
...
#define fsclfstools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fsclfstools_getopt(
                  int argument_count,
...
void fsclfstools_getopt_wrapped_fprint(
      FILE *stream,
...
void fsclfstools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const fsclfstools_option_t *options,
      int number_of_options );

int fsclfstools_getopt_get_options_string(
     const fsclfstools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _FSCLFSTOOLS_GETOPT_H ) */
