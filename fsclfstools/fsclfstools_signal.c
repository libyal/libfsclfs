...
void (*fsclfstools_signal_signal_handler)( fsclfstools_signal_t ) = NULL;
...
{
	static char *function = "fsclfstools_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( fsclfstools_signal_signal_handler != NULL )
			{
				fsclfstools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "fsclfstools_signal_attach";
	...
	fsclfstools_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     (PHANDLER_ROUTINE) fsclfstools_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	fsclfstools_signal_initialize_memory_debug();
#endif
...
int fsclfstools_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "fsclfstools_signal_detach";
	...
	fsclfstools_signal_signal_handler = NULL;
