...
#if !defined( _FSCLFS_TEST_GETOPT_H )
#define _FSCLFS_TEST_GETOPT_H
...
#define fsclfs_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fsclfs_test_getopt(
                  int argument_count,
...
#endif /* !defined( _FSCLFS_TEST_GETOPT_H ) */
