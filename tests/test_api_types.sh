...
TEST_TYPES="block block_descriptor container container_descriptor io_handle log_range owner_page record record_value stream stream_descriptor";
TEST_TYPES_WITH_INPUT="store";
OPTION_SETS="";
