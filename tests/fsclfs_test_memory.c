...
static void *(*fsclfs_test_real_memcpy)(void *, void *, size_t) = NULL;
       ...
       size_t size )
{
	...
	else if( fsclfs_test_malloc_attempts_before_fail > 0 )
	{
		fsclfs_test_malloc_attempts_before_fail--;
	}
	ptr = fsclfs_test_real_malloc(
	       size );
       ...
       size_t size )
{
	...
	{
		fsclfs_test_memcpy_attempts_before_fail = -1;

		return( NULL );
	}
	else if( fsclfs_test_memcpy_attempts_before_fail > 0 )
	{
		fsclfs_test_memcpy_attempts_before_fail--;
	}
	destination = fsclfs_test_real_memcpy(
	               destination,
	               source,
	               size );
       ...
       size_t size )
{
	...
	else if( fsclfs_test_memset_attempts_before_fail > 0 )
	{
		fsclfs_test_memset_attempts_before_fail--;
	}
	ptr = fsclfs_test_real_memset(
	       ptr,
	       constant,
	       size );
       ...
       size_t size )
{
	...
	{
		fsclfs_test_realloc_attempts_before_fail = -1;

		return( NULL );
	}
	else if( fsclfs_test_realloc_attempts_before_fail > 0 )
	{
		fsclfs_test_realloc_attempts_before_fail--;
	}
	ptr = fsclfs_test_real_realloc(
	       ptr,
	       size );
