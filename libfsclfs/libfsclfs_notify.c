...
{
	static char *function = "libfsclfs_notify_set_stream";
...
int libfsclfs_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfsclfs_notify_stream_open";
...
int libfsclfs_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libfsclfs_notify_stream_close";
