...
const char *libfsclfs_get_version(
             void )
{
	return( (const char *) LIBFSCLFS_VERSION_STRING );
}
...
int libfsclfs_get_access_flags_read(
     void )
{
	return( (int) LIBFSCLFS_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libfsclfs_get_codepage";
...
int libfsclfs_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfsclfs_set_codepage";
